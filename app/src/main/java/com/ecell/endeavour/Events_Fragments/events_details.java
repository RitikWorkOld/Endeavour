...
import com.ecell.endeavour.BQuiz.bquiz_intro;
import com.ecell.endeavour.R;
import com.ecell.endeavour.Voting.VotingAct;
import com.ecell.endeavour.Voting.Voting_helper;
                ...
                if(!haveNetworkConnection()){
                    ...
                    else
                    {
                        ...
                        databaseReference2.addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                getphno getphno = dataSnapshot.getValue(com.ecell.endeavour.Events_Fragments.getphno.class);
