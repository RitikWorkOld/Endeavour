    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent( Payment_one.this, checksum.class );
        ...
        if (ContextCompat.checkSelfPermission
                ( Payment_one.this, Manifest.permission.READ_SMS ) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions
                    ( Payment_one.this, new String[]{Manifest.permission.READ_SMS, Manifest.permission.RECEIVE_SMS}, 101 );
